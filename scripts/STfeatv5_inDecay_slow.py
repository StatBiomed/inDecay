...
def read_data(OligoID, processed_df, experiments):
    ...
    # read feature data
    filename = f"{OligoID}_{Guide}_features.txt"
    feature_path = pj(PATH.data_dir, 'IndelFeature_result', filename)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-S","--Feature_slice", required=False, type=str, default="0:60", help="the slice of which the feature will be used for modeling")
    ...
    feat_dir = pj(PATH.data_dir, 'IndelFeature_result')
